...
public void user_put_the_creation_time_last_modtime_in_json(String programName, String progDes, String progStatus) {
	...
	{
		logger.info("Please enter all the required fields in body");
	}
}
...
@When("User Put the {string},{string},creation time,lastModtime in Json")
public void user_put_the_creation_time_last_modtime_in_json(String programName, String progDes) {
	try
	{
	SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.000+00:00");
	String d =df.format(new Date()).toString();
	...
	{
	logger.info("Please enter all the fields in body to complete POST request");
	}
}

@When("Program should not be created")
public void program_should_not_be_created() {
