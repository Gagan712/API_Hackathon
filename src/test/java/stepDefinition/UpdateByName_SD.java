...
public class UpdateByName_SD {
	...
	public void user_get_the_base_url_for_progam_by_name() {
		logger.info("Use get the Base URI");
		RestAssured.baseURI =baseurl;
	}

	@When("User Put the data in map for Progam by name")
	public void user_put_the_data_in_map_for_progam_by_name() {
		logger.info("Put all the data for program body");
		  // map.put("programId", progID);
		   map.put("programName", "Jan23-Cloud 8797");
		   map.put("programDescription", "Learn Cloud in 7 days");
	...
	public void request_body_with_given_data_for_progam_by_name() {
	...
	public void make_a_post_request_for_progam_by_name() {
	...
	public void save_the_program_id_for_progam_by_name() {
	...
	public void validate_the_status_code_for_progam_by_name() {
	...
	public void make_a_get_request_by_program_id_for_progam_by_name() {
	...
	public void validate_the_get_status_code_for_progam_by_name() {
		System.out.println(response.getStatusCode());
		request.then().statusCode(200);
	}

	@Then("Save the ProgramName for Progam by name")
	public void save_the_program_name_for_progam_by_name() {
		logger.info("User save the programName");
		 progName =response.jsonPath().get("programName");
		 logger.info(progName);
		System.out.println("Program Name = "+ progName);
	}

	@When("Set Update Request Body for Progam by name")
	public void set_update_request_body_for_progam_by_name() {
		logger.info("Put all the data for program body");
		   map.put("programId", progID);
		   map.put("programName", progName);
		   map.put("programDescription", "Learn Cloud in 10 days");
		   map.put("programStatus", "Active");
		   map.put("creationTime", "2022-09-28T19:53:25.244+00:00");
		   map.put("lastModTime", "2022-09-28T19:53:25.244+00:00");
	}

	@When("Make a Put request for Progam by name")
	public void make_a_put_request_for_progam_by_name() {
		...
		JSONObject updateBody = new JSONObject(map);
		   ...
		   request.header("Content-Type","Application/json")
	        ...
	        response= request.when().put("/program/"+progName);
	        response.prettyPrint();
	}

	@Then("validate the put status code for Progam by name")
	public void validate_the_put_status_code_for_progam_by_name() {
	...
	public void user_get_the_base_url_for_delete_for_progam_by_name() {
		logger.info("Use get the Base URI");
		RestAssured.baseURI =baseurl;
	}

	@When("Make a Delete request for Progam by name")
	public void make_a_delete_request_for_progam_by_name() {
		logger.info("User make a delete request by programID");
		request = RestAssured.given();
		response= request.when().delete("/deletebyprogname/"+progName);
		response.prettyPrint();
	}

	@Then("validate the delete status code for Progam by name")
	public void validate_the_delete_status_code_for_progam_by_name() {
